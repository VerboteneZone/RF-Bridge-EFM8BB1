...
SI_SEGMENT_VARIABLE(PROTOCOL_PULSES(KaKu)[], static uint16_t, SI_SEG_CODE) = { 300, 2560, 140, 1150, 10230 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(KaKu)[], static uint8_t, SI_SEG_CODE) = { 0, 1 };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(KaKu)[], static uint8_t, SI_SEG_CODE) = { 0, 3, 0, 2 };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(KaKu)[], static uint8_t, SI_SEG_CODE) = { 0, 2, 0, 3 };
SI_SEGMENT_VARIABLE(PROTOCOL_END(KaKu)[], static uint8_t, SI_SEG_CODE) = { 0, 4 };
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
		 ...
		 */
		{
			{ &PROTOCOL_PULSES(KaKu), ARRAY_LENGTH(PROTOCOL_PULSES(KaKu)) },
